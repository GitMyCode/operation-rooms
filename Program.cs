...
#else
            Console.WriteLine(@"Path du fichier a lire (ex: C:\Users\blabla\Desktop\Test.ods)");
            readFilePath = Console.ReadLine();
            Console.WriteLine(@"Path du fichier ou ecrire les resultats (ex: C:\Users\blabla\Desktop\resultat.ods)");
